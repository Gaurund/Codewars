...
How to take the determinant of a matrix -- it is simplest 
to start with the smallest cases:
...
of the 2x2 matrix created by crossing out the row and column in which the element a occurs:
